...
template<int dimension, typename DATATYPE, typename MAPTYPE, DEVICETYPE device> 
void DenseTensor<dimension,DATATYPE,MAPTYPE,device>::global_insert_value(const std::array<int, dimension> global_array_index, const DATATYPE value){
...
template<int dimension, typename DATATYPE, typename MAPTYPE, DEVICETYPE device> 
void DenseTensor<dimension,DATATYPE,MAPTYPE,device>::local_insert_value(const std::array<int, dimension> local_array_index, const DATATYPE value){
...
template<int dimension, typename DATATYPE, typename MAPTYPE, DEVICETYPE device> 
void DenseTensor<dimension,DATATYPE,MAPTYPE,device>::global_insert_value(const int global_index, const DATATYPE value){
...
template<int dimension, typename DATATYPE, typename MAPTYPE, DEVICETYPE device> 
void DenseTensor<dimension,DATATYPE,MAPTYPE,device>::local_insert_value(const int local_index, const DATATYPE value) {
...
template<int dimension, typename DATATYPE, typename MAPTYPE, DEVICETYPE device> 
void DenseTensor<dimension,DATATYPE,MAPTYPE,device>::global_set_value(std::array<int, dimension> global_array_index, DATATYPE value){
    int local_index = this->map.unpack_local_array_index(this->map.global_to_local(global_array_index));
    local_set_value(local_index, value);
    return;
}
template<int dimension, typename DATATYPE, typename MAPTYPE, DEVICETYPE device> 
void DenseTensor<dimension,DATATYPE,MAPTYPE,device>::local_set_value(std::array<int, dimension> local_array_index, DATATYPE value) {
    for(int i=0;i<dimension;i++){
        assert ( local_array_index[i] < this->map.get_local_shape(i));
    }
...
template<int dimension, typename DATATYPE, typename MAPTYPE, DEVICETYPE device> 
void DenseTensor<dimension,DATATYPE,MAPTYPE,device>::global_set_value(int global_index, DATATYPE value) {
    int local_index = this->map.global_to_local(global_index);
    local_set_value(local_index, value);
}
template<int dimension, typename DATATYPE, typename MAPTYPE, DEVICETYPE device> 
void DenseTensor<dimension,DATATYPE,MAPTYPE,device>::local_set_value(int local_index, DATATYPE value) {
    assert (local_index <this->map.get_num_local_elements());
	if(local_index<0) return;
    this->data[local_index] = value;
    return;
