...
template<>
void memcpy<int, DEVICETYPE::MPI>(int* dest, const int* source, size_t size, COPYTYPE copy_type){
    std::memcpy(dest, source, size * sizeof(int));
}

template<>
void memcpy<size_t, DEVICETYPE::MPI>(size_t* dest, const size_t* source, size_t size, COPYTYPE copy_type){
    std::memcpy(dest, source, size * sizeof(size_t));
}

template<>
void memcpy<double, DEVICETYPE::MPI>(double* dest, const double* source, size_t size, COPYTYPE copy_type){
...
template <>
void gemv<double, DEVICETYPE::MPI>(const ORDERTYPE order, const TRANSTYPE transa, const size_t m, const size_t n, const double alpha,
